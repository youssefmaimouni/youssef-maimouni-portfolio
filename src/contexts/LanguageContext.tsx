...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "about.bio1": "I'm a Master's student in Computer Science & Mathematics for Data Science at ENSA Khouribga, passionate about Artificial Intelligence, Machine Learning, NLP, and Computer Vision.",
    "about.bio2": "I love building AI-powered systems that connect data, algorithms, and real-world impact. My experience ranges from developing computer vision pipelines for retail analytics to processing 52,000+ Arabic articles for intelligent clustering.",
    "about.bio3": "Beyond technical work, I'm actively involved in the tech community as a Project Manager at JLM ENSA Khouribga and Director of Events & Logistics at ResearchX Club.",
  ...
  fr: {
    ...
    "about.bio1": "Je suis étudiant en Master en Informatique et Mathématiques pour la Science des Données à l'ENSA Khouribga, passionné par l'Intelligence Artificielle, le Machine Learning, le NLP et la Vision par Ordinateur.",
    "about.bio2": "J'aime construire des systèmes alimentés par l'IA qui connectent les données, les algorithmes et l'impact réel. Mon expérience va du développement de pipelines de vision par ordinateur pour l'analyse retail au traitement de plus de 52 000 articles arabes pour le clustering intelligent.",
    "about.bio3": "Au-delà du travail technique, je suis activement impliqué dans la communauté tech en tant que Chef de Projet à JLM ENSA Khouribga et Directeur des Événements et Logistique au Club ResearchX.",
